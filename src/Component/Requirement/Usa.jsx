          ...
          <div className="row gap-4">
            ...
            <div className="col-md-6 bg-white p-4">
              ...
              <ul className="mb-3">
                <li className="list">
                  <b>Passport:</b>
                  <br /> The applicant needs to submit an original Passport that
                  was issued within 10 years. The passport must have six months
                  of validity after the intended date of departure. The
                ...
                <li className="list">
                  <b>Visa Application Form for United States:</b>
                  <br /> 07 Months Valid Passport With Old Passport (If have)
                </li>
                <li className="list">
                  <b>Photograph:</b>
                  <br />
                ...
                <li className="list">
                  <b>Cover Letter for the United States:</b>
                  <br /> A personal letter from the applicant covering personal
                  details, the purpose of the visit, and outlining who will be
                  responsible for the full costs of the trip. Travel, the
                  accommodation also need to include. The letter should be
                  addressed to The Visa Officer, U.S. Embassy, Dhaka. The Visa
                  category must be mentioned in the subject line. The purpose of
                  your visit to the United States is for a temporary visit,
                  business visit, or medical treatment. Remain time in the
                  united states specifically and evidence of founds.
                </li>
                <li className="list">
              ...
              <div className="card p-1">
                <div className="card-body">
                  <h4 className="card-title">
                    Sticker visa (USA) Type:Sticker Visa
                  </h4>
